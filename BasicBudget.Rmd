...
init =  list(mu=mu.ic+alpha.ic,tau_obs=prec.ic,tau_proc.mu=tau_year.ic,rhop0=rhop.ic,rho0=rho.ic,tau_proc.rhop=tau_proc.rhop.ic,tau_h.rho=tau_h.ic)
```
